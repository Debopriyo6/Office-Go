   ...
   <section className='bg-gray-50 min-h-screen flex items-center justify-center'>
    <div className='bg-gray-100 flex rounded-2x1 shadow-lg max-w-3xl p-5 items-center'>
      ...
      <div className='md:w-1/2 px-16'>
       ...
       <p className='text-sm mt-4 text-[#0CBBC0] '>If you already a member login in</p>
       <form className='flex flex-col gap-4'>
        ...
        <button className='bg-[#0CBBC0] rounded-xl text-white py-2 hover:scale-105 duration-300'>Login</button>
       </form>
        ...
        <svg class="mr-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="25px">
          ...
          <div className='mt-3 text-xs flex justify-between items-center text-[#0CBBC0]'>
            ...
            <button className='py-2 px-5 bg-white border rounded-xl hover:scale-112 duration-300'>Register</button>
      ...
      <img className='rounded-2xl ' src='https://lisnr.com/wp-content/uploads/2021/03/Shuttl_PR_Piece.png' alt='loading..'/>
      </div>
